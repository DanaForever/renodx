...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r0.rgb = expandGamut(r1.rgb, shader_injection.unreal_expand_gamut);
  ...
  float3 untonemapped_ap1 = max(0.f, r0.rgb);
  ...
  if (false) {
    ...
    // r3.rgb = renodx::tonemap::aces::RRT(mul(renodx::color::AP1_TO_AP0_MAT, untonemapped_ap1));
    // // r3.rgb = unrealengine::filmtonemap::ApplyToneCurve(r3.rgb, cb_config.ue_filmslope, cb_config.ue_filmtoe, cb_config.ue_filmshoulder, cb_config.ue_filmblackclip, cb_config.ue_filmwhiteclip);

    // float3 vanilla = unrealengine::filmtonemap::ApplyToneCurve(r3.rgb, cb_config.ue_filmslope, cb_config.ue_filmtoe, cb_config.ue_filmshoulder, cb_config.ue_filmblackclip, cb_config.ue_filmwhiteclip);
    // r3.rgb = ApplyToneCurveExtended(r3.rgb, cb_config.ue_filmslope, cb_config.ue_filmtoe, cb_config.ue_filmshoulder, cb_config.ue_filmblackclip, cb_config.ue_filmwhiteclip);

    // r3.rgb = CorrectHueAndPurityMB(renodx::color::bt709::from::AP1(r3.rgb), renodx::color::bt709::from::AP1(vanilla));
    // r3.rgb = renodx::color::ap1::from::BT709(r3.rgb);
  ...
  r0.rgb = PostProcess(r2.rgb, cb_config, true);
  // r0.rgb = r2.rgb;
