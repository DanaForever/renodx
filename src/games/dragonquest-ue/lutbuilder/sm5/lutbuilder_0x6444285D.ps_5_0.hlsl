// ---- Created with 3Dmigoto v1.3.16 on Sat Feb 21 00:34:13 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = cb0[35].xxx * float3(0.000154118257,0.00084242021,4.22806261e-005) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[35].x * cb0[35].x;
  r2.xyz = r0.www * float3(1.28641219e-007,7.08145137e-007,4.20481676e-008) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[35].x * 2.8974182e-005 + 1;
  ...
  cb_config.ColorCurve_Cm0Cd0_Cd2_Ch0Cm1_Ch3 = cb0[22];  // ColorCurve_Cm0Cd0_Cd2_Ch0Cm1_Ch3
  cb_config.ColorCurve_Ch1_Ch2 = cb0[23];                // ColorCurve_Ch1_Ch2
  cb_config.ColorMatrixR_ColorCurveCd1 = cb0[19];        // ColorMatrixR_ColorCurveCd1
  cb_config.ColorMatrixG_ColorCurveCd3Cm3 = cb0[20];     // ColorMatrixG_ColorCurveCd3Cm3
  cb_config.ColorMatrixB_ColorCurveCm2 = cb0[21];        // ColorMatrixB_ColorCurveCm2
  cb_config.ColorShadow_Luma = cb0[24];                  // ColorShadow_Luma,
  cb_config.ColorShadow_Tint1 = cb0[25];                 // Tint
  cb_config.ColorShadow_Tint2 = cb0[26];                 // Tint
      ...
      if (r0.w != 0) {
        ...
        if (r0.w != 0) {
          ...
          if (r0.w != 0) {
            ...
            r7.xyzw = float4(2.67146462e+013,0.146704003,2.67146462e+013,0.146704003) * r0.xxyy;
            r1.xy = r1.xy * float2(-2.15104839e+013,-2.15104839e+013) + r7.xz;
            r1.xy = float2(2.77357507e+010,2.77357507e+010) + r1.xy;
            r1.xy = rsqrt(r1.xy);
            r1.xy = float2(1,1) / r1.xy;
            r1.xy = r1.xy * float2(-6.32456008e-008,-6.32456008e-008) + -r7.yw;
            ...
            r0.xy = float2(2.67146462e+013,0.146704003) * r0.zz;
            r0.x = r1.z * -2.15104839e+013 + r0.x;
            r0.x = 2.77357507e+010 + r0.x;
            r0.x = rsqrt(r0.x);
            r0.x = 1 / r0.x;
            r0.x = r0.x * -6.32456008e-008 + -r0.y;
            ...
            r0.x = r0.y ? 1.00000001e-010 : r0.x;
            r0.y = r0.w / r0.x;
            r0.x = r1.x / r0.x;
            r0.z = max(0, r1.x);
            r0.z = min(65535, r0.z);
            ...
            if (r0.w != 0) {
              ...
              if (r1.x != 0) {
                ...
                if (r1.x != 0) {
                  ...
                  if (r2.w != 0) {
                    r1.xyzw = float4(-1.69896996,-1.47790003,-1.22909999,1.40129846e-045);
                  } else {
                    ...
                    r1.xyzw = r9.xxxx ? float4(-1.47790003,-1.22909999,-0.864799976,2.80259693e-045) : r8.yzwx;
                  }
                }
                ...
                if (r1.x != 0) {
                  ...
                  if (r1.x != 0) {
                    ...
                    if (r2.w != 0) {
                      r1.xyzw = float4(0.847043753,1.1358,1.38020003,1.40129846e-045);
                    } else {
                      ...
                      r1.xyzw = r9.xxxx ? float4(1.1358,1.38020003,1.51970005,2.80259693e-045) : r8.yzwx;
                    }
                  }
                  r1.z = dot(r1.xzy, float3(0.5,0.5,-1));
                  r2.w = dot(r1.xy, float2(-1,1));
            ...
            if (r0.y != 0) {
              ...
              if (r0.w != 0) {
                ...
                if (r0.w != 0) {
                  ...
                  if (r0.w != 0) {
                    r8.xyzw = float4(-1.69896996,-1.47790003,-1.22909999,1.40129846e-045);
                  } else {
                    ...
                    r8.xyzw = r10.xxxx ? float4(-1.47790003,-1.22909999,-0.864799976,2.80259693e-045) : r9.yzwx;
                  }
                }
                ...
                if (r0.w != 0) {
                  ...
                  if (r0.w != 0) {
                    ...
                    if (r0.w != 0) {
                      r8.xyzw = float4(0.847043753,1.1358,1.38020003,1.40129846e-045);
                    } else {
                      ...
                      r8.xyzw = r10.xxxx ? float4(1.1358,1.38020003,1.51970005,2.80259693e-045) : r9.yzwx;
                    }
                  }
                  r0.w = dot(r8.xzy, float3(0.5,0.5,-1));
                  r1.w = dot(r8.xy, float2(-1,1));
            ...
            r0.xy = max(float2(1.00000001e-010,1.00000001e-010), r0.xw);
            r0.y = log2(r0.y);
