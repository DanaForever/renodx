// ---- Created with 3Dmigoto v1.3.16 on Fri Feb 27 23:08:51 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // r0.yzw = renodx::lut::SampleTetrahedral(t3, r0.yzw, 32u).xyz;
  ...
  if (r0.w != 0) {
    ...
    // pq in nits, but AP1 instead of BT2020
    ...
    o0.xyz = r0.xyz;
    o0.w = saturate(renodx::color::y::from::BT709(renodx::color::srgb::DecodeSafe(o0.rgb)));
  }
  return;
}