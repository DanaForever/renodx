// ---- Created with 3Dmigoto v1.3.16 on Sun Mar 15 19:01:03 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = cb0[62].y * -r1.x;
  r1.yzw = r1.yzw * cb1[134].zzz + r5.xyz;
  r1.yzw = r4.xyz * cb1[134].zzz + r1.yzw;
  ...
  r0.yzw = exp2(r0.yzw);
  r1.xyz = r0.yzw * float3(18.8515625,18.8515625,18.8515625) + float3(0.8359375,0.8359375,0.8359375);
  ...
  // r0.xyz = float3(0.00100000016,0.00100000016,0.00100000016) * r0.xyz;
  ...
  if (cb0[65].x != 0) {
    ...
    r2.rgb = renodx::color::pq::DecodeSafe(r0.rgb, RENODX_DIFFUSE_WHITE_NITS);
    ...
    o0.w = saturate(renodx::color::y::from::BT709(r2.rgb));
    o0.xyz = r2.xyz * RENODX_DIFFUSE_WHITE_NITS / 80.f;
