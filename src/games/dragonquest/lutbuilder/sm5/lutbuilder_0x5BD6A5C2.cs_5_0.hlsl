...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r0.w = 1.00055635 * cb0[44].z;
  r0.w = 1 / r0.w;
  r1.x = cmp(6996.10791 >= cb0[44].z);
  ...
  r2.xyz = cb0[44].zzz * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[44].z * cb0[44].z;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[44].z * 2.8974182e-05 + 1;
