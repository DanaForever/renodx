// ---- Created with 3Dmigoto v1.3.16 on Wed Feb 25 18:56:09 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  cb_config.ue_tonecurveammount = 1.0f;                   // still not present as a separate cbuffer in this game
