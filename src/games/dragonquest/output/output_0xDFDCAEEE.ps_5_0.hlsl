  ...
  out float4 o0 : SV_Target0)
{
  ...
  // r1.rgb = renodx::color::pq::DecodeSafe(r1.rgb, 100.f);
  ...
  // r0.rgb = renodx::color::pq::DecodeSafe(r0.rgb, 1.f);
  float3 color;
  // Tonemapping
  if (RENODX_TONE_MAP_TYPE > 0.f) {
    r0.rgb = LMS_Vibrancy(r0.rgb, shader_injection.tone_map_saturation, shader_injection.tone_map_contrast);
    r0.rgb = CastleDechroma_CVVDPStyle_NakaRushton(r0.rgb, RENODX_DIFFUSE_WHITE_NITS);
    ...
    float3 bt2020_final_color = renodx::color::bt2020::from::BT709(r0.rgb);                                             // displaymap in bt2020
    ...
    color = bt709_displaymapped_color;
  } else {
    color = r0.rgb;
  }
