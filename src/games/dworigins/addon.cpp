...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x02446D96),  // output processing
    CustomShaderEntry(0xD2B8CD28),  // tonemapper
    CustomShaderEntry(0x7D8A20C5),  // tonemapper
    CustomShaderEntry(0xB8536907),  // lutbuilder
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .labels = {"Vanilla HDR", "Extended Curve with PsychoV"},
...
extern "C" __declspec(dllexport) constexpr const char* NAME = "DWO RenoDX";
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Dynasty Warriors: Origins";
