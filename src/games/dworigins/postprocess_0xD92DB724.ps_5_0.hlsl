  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = (uint)r0.x >> 16;
  r0.x = (uint)r0.x;
  r1.x = r0.x * 1.52590219e-005 + 0.25;
  ...
  r0.y = (uint)r0.y >> 16;
  r0.y = (uint)r0.y;
  r1.z = r0.y * 1.52590219e-005 + 0.25;
  r0.x = 0x010dcd00 * (int)icb[r0.x+0].x;
  r0.x = (uint)r0.x >> 16;
  r0.x = (uint)r0.x;
  r1.y = r0.x * 1.52590219e-005 + 0.25;
  ...
  r2.xyz = g_cbNoiseInfo.zzz * r0.xyz + r2.xyz;
  r0.xyzw = log2(abs(r2.xyzw));
  r0.xyzw = g_cbColorInfo.yyyy * r0.xyzw;
  r0.xyzw = exp2(r0.xyzw);
  r0.xyzw = g_cbColorInfo.zzzz * r0.xyzw;
  r1.x = cmp(1 < g_cbColorInfo.x);
