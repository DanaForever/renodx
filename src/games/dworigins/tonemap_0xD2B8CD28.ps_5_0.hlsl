// ---- Created with 3Dmigoto v1.3.16 on Sun Feb 15 17:13:52 2026
#include "common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // float3 untonemapped = renodx::color::srgb::DecodeSafe(r3.rgb);
  ...
  // r1.rgb = renodx::lut::SampleTetrahedral(g_tHdrLut, renodx::color::arri::logc::c1000::Encode(untonemapped));
#endif
  ...
  if (r2.w != 0) {
    ...
    // r3.rgb = renodx::lut::SampleTetrahedral(g_tDramaticHdrLut0, renodx::color::arri::logc::c1000::Encode(untonemapped));
  ...
  if (r2.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      if (r2.w == 0) {
        ...
        if (8 == 0) r2.z = 0; else if (8+16 < 32) {         r2.z = (uint)g_vDramaticHdrLutInfo1[0].z << (32-(8 + 16)); r2.z = (uint)r2.z >> (32-8);        } else r2.z = (uint)g_vDramaticHdrLutInfo1[0].z >> 16;
        if (r2.z != 0) {
  ...
  if (r2.y != 0) {
    ...
    // r0.rgb = renodx::lut::SampleTetrahedral(g_tLdrLut, r0.rgb);
    // r0.xyz = r0.xyz + -r1.xyz;
