...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x22F1555A),
    CustomShaderEntry(0x2546D5B8),
    CustomShaderEntry(0xBB09D0B3),
    CustomShaderEntry(0xED457D04),  // LUTBuilder LDR
    CustomShaderEntry(0x5FDD841D),  // Light
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .labels = {"Vanilla", "DICE", "ACES", "RenoDRT"},
    ...
    new renodx::utils::settings::Setting{
        .key = "ToneMapNeutral",
        .binding = &shader_injection.tone_map_neutral,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .can_reset = true,
        .label = "Neutral Tone Mapper",
        .section = "Tone Mapping",
        .tooltip = "Sets the tone mapper mode",
        .labels = {"NeutralDRT", "Fast Reinhard"},
        .is_visible = []() { return current_settings_mode >= 1; },
    },
    new renodx::utils::settings::Setting{
    ...
    // End new settings for Unity LUT
    new renodx::utils::settings::Setting{
