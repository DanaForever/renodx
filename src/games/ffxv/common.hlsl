...
float3 CustomToneMapPass(float3 color, renodx::draw::Config draw_config) {
  ...
  draw_config.tone_map_per_channel = 1.f;
  ...
  tone_map_config.reno_drt_tone_map_method = renodx::tonemap::renodrt::config::tone_map_method::REINHARD;
...
float3 ToneMapLMS(float3 untonemapped) {
  ...
  if (RENODX_TONE_MAP_TYPE == 2.f) {
    ...
    bt709_tonemapped = CustomToneMapPass(untonemapped_graded_dechroma, renodx::draw::BuildConfig());  
