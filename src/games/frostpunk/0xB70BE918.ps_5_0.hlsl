...
SamplerState VerticalBlurTextureSampler_s : register(s1);
SamplerState DiagonalBlurTextureSampler_s : register(s2);
Texture2D<float4> VerticalBlurTexture : register(t1);
Texture2D<float4> DiagonalBlurTexture : register(t2);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  float4 x0[2];
  r0.xyzw = DiagonalBlurTexture.Sample(DiagonalBlurTextureSampler_s, v1.xy).xyzw;
  ...
  while (true) {
    ...
    r5.xyzw = VerticalBlurTexture.Sample(VerticalBlurTextureSampler_s, r4.xy).xyzw;
    r4.x = cmp(r5.w < 0);
    ...
    r4.x = r4.y + r4.x;
    x0[0].x = r4.x;
    r4.xyzw = DiagonalBlurTexture.Sample(DiagonalBlurTextureSampler_s, r4.zw).xyzw;
    r5.x = cmp(r4.w < 0);
  ...
  r0.w = max(abs(r3.w), abs(r2.w));
  o0.w = min(1, r0.w);
  r0.xyz = r1.xyz + r0.xyz;
  o0.xyz = float3(0.000325488276,0.000325488276,0.000325488276) * r0.xyz;
  return;
}