...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x611A6B60),  // output
    // CustomShaderEntry(0x1A8BD17A),  // output
    CustomShaderEntry(0x2FC0DE50),  // output
...
renodx::utils::settings::Settings settings = renodx::templates::settings::CreateDefaultSettings({
    ...
    {"ToneMapClampColorSpace", &shader_injection.tone_map_per_channel},
