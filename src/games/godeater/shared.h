...
#define RENODX_PEAK_WHITE_NITS               1100.f // shader_injection.peak_white_nits
#define RENODX_DIFFUSE_WHITE_NITS            203.f // shader_injection.diffuse_white_nits
#define RENODX_GRAPHICS_WHITE_NITS           203.f //shader_injection.graphics_white_nits
#define RENODX_TONE_MAP_TYPE                 3.f // shader_injection.tone_map_type
...
#define RENODX_GAMMA_CORRECTION                   renodx::draw::GAMMA_CORRECTION_SRGB// shader_injection.gamma_correction
...
#define RENODX_INTERMEDIATE_ENCODING renodx::draw::GAMMA_CORRECTION_SRGB
