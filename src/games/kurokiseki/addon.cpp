...
renodx::utils::settings::Settings settings = {
    ...
    //     .section = "Tone Mapping",
    //     .tooltip = "Sets the LMS matrix, if its not None, tonemapping will be done to human vision peak before display mapping.",
    //     .labels = {"None", "Von-Kries", "Sharp", "Fairchild", "Stockman"},
    //     .is_enabled = []() { return shader_injection.tone_map_type >= 1; },
    //     .is_visible = []() { return current_settings_mode >= 2; },
    // },
    new renodx::utils::settings::Setting{
    ...
    new renodx::utils::settings::Setting{
        ...
        // .is_visible = []() { return current_settings_mode >= 2 && shader_injection.tone_map_type >= 3; },
