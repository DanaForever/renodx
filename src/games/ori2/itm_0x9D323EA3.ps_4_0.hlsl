    ...
    out float4 o0: SV_Target0)
{
  ...
  if (injectedData.toneMapType != 0) {
    ...
    // o0.rgb = renodx::color::correct::Hue(o0.rgb, itm.rgb, injectedData.toneMapHDRBlendFactor);
    // o0.rgb = renodx::color::correct::Chrominance(o0.rgb, itm.rgb, injectedData.toneMapHDRBlendFactor);
