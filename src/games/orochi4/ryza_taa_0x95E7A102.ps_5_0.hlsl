// ---- Created with 3Dmigoto v1.3.16 on Thu Feb 19 14:56:58 2026

cbuffer _Globals : register(b0)
{
  row_major float4x4 g_cbMatCW : packoffset(c0);
  row_major float4x4 g_cbMatPrevWC : packoffset(c4);
  float screenWidth : packoffset(c8);
  float screenHeight : packoffset(c8.y);
  float jitterScale : packoffset(c8.z);
