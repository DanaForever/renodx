#ifndef SRC_OROCHI4_SHARED_H_
#define SRC_OROCHI4_SHARED_H_
...
#define RENODX_INTERMEDIATE_ENCODING         1.0f // shader_injection.intermediate_encoding
#define RENODX_SWAP_CHAIN_DECODING           1.0f // shader_injection.swap_chain_decoding
#define RENODX_SWAP_CHAIN_GAMMA_CORRECTION   0.f // shader_injection.swap_chain_gamma_correction
