...
SamplerState smplFXAA_s : register(s3);
...
Texture2D<float4> smplFXAA_Tex : register(t3);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = smplBloom_Tex.Sample(smplBloom_s, v1.xy).xyz;
  r0.yzw = fBloomWeight * r0.yzw;
  r1.xy = v1.xy * vTexUVOffset.zw + vTexUVOffset.xy;
  r1.xyzw = smplFXAA_Tex.Sample(smplFXAA_s, r1.xy).xyzw;
