// ---- Created with 3Dmigoto v1.3.16 on Sun Jul 27 15:15:13 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float2 ProjectionScale : packoffset(c85.y) = {1,1};
  float2 WindyGrassDirection : packoffset(c86) = {0,0};
  float WindyGrassSpeed : packoffset(c86.z) = {0.100000001};
  float WindyGrassHomogenity : packoffset(c86.w) = {2};
  float WindyGrassScale : packoffset(c87) = {1};
  float BloomIntensity : packoffset(c87.y) = {1};
  float MaskEps : packoffset(c87.z);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.x = r6.x * r2.x;
  r6.xzw = r5.xyz * r2.yyy;
  r2.xyw = r2.xxx * r3.xyz + r6.xzw;
