// ---- Created with 3Dmigoto v1.3.16 on Fri Jul 11 00:12:34 2025
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.w = Shininess * r1.x;
  r5.x = dot(Light0.m_direction.xyz, r2.xyz);
  r5.x = r5.x * 0.5 + 0.5;
  r5.x = r5.x * r5.x;
  ...
  r2.w = min(1, r2.w);
  r2.w = r2.w * r4.w;
  r3.xyz = Light0.m_colorIntensity.xyz * r5.xxx + scene.GlobalAmbientColor.xyz;
