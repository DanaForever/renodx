// ---- Created with 3Dmigoto v1.3.16 on Sun Jun 08 15:05:14 2025
#include "../shared.h"
...
SamplerState DiffuseMap3SamplerSampler_s : register(s4);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyzw = DiffuseMap3Sampler.Sample(DiffuseMap3SamplerSampler_s, v6.xy).xyzw;
  r0.w = v1.w * r3.w;
  r0.xyz = r3.xyz * r0.www + r0.xyz;
  ...
  r1.w = r1.w * 0.5 + 0.5;
  r1.w = r1.w * r1.w;
  r5.xyz = Light0.m_colorIntensity.xyz * r1.www + scene.GlobalAmbientColor.xyz;
  ...
  r4.x = dot(r3.xyz, scene.View._m00_m10_m20);
  r4.y = dot(r3.xyz, scene.View._m01_m11_m21);
  r1.xw = r4.xy * scene.AlphaTestDirection + r2.xy;
  r1.yz = r1.yz * v0.ww + -r1.xw;
  r1.xy = scene.AdditionalShadowOffset * r1.yz + r1.xw;
  r1.xy = r1.xy / v0.ww;
  r1.xyz = RefractionTexture.Sample(LinearClampSamplerState_s, r1.xy).xyz;
  r1.w = PointLightParams.w * r6.w;
  ...
  r6.xyz = r1.www * r0.xyz + r2.xyz;
  r1.xyzw = GameMaterialDiffuse.xyzw * r6.xyzw;
