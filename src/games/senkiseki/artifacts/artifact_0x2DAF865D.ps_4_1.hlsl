// ---- Created with 3Dmigoto v1.3.16 on Sun Jul 27 14:43:37 2025
...
Texture2D<float4> ProjectionMapSampler : register(t5);
  ...
  out float4 o2 : SV_TARGET2)
{
      ...
      if (r3.x != 0) {
        ...
        if (r3.x != 0) {
          ...
          if (r1.y != 0) {
            ...
            r5.z = 0;
            r6.xyz = r5.xyz + r2.xyz;
            r3.y = LightShadowMap0.SampleCmpLevelZero(LinearClampCmpSamplerState_s, r6.xy, r6.z).x;
            r1.w = r3.y * 0.0625 + r1.w;
            r6.xy = r1.yz * r0.ww;
            r6.z = 0;
            r7.xyz = r6.xyz + r2.xyz;
            ...
            r4.xyz = r4.zyz + r2.xyz;
            r1.z = LightShadowMap0.SampleCmpLevelZero(LinearClampCmpSamplerState_s, r4.xy, r4.z).x;
  ...
  r1.y = r1.z ? 0 : r1.y;
  r0.w = r0.w * r1.x + r1.y;
  r1.x = dot(v6.xyz, Light0.m_direction.xyz);
  r1.x = r1.x * 0.5 + 0.5;
  ...
  r0.w = r2.w + r0.w;
  r0.w = min(1, r0.w);
  r1.xy = ProjectionMapSampler.Sample(LinearWrapSamplerState_s, v5.xy).xw;
  r1.x = -r1.x * r1.y + 1;
  r0.w = min(r1.x, r0.w);
  r1.x = 1 + -r0.w;
  ...
  r0.w = r1.x * r1.y + r0.w;
  r1.xyz = NormalMapSampler.Sample(NormalMapSamplerSampler_s, v3.xy).xyz;
  ...
  r3.x = dot(Light0.m_direction.xyz, r1.xyz);
  r3.x = r3.x * 0.5 + 0.5;
  r3.x = r3.x * r3.x;
  r3.yzw = SpecularColor.xyz * Light0.m_colorIntensity.xyz;
  r2.xyz = r2.xyz * r1.www + Light0.m_direction.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  ...
  r1.w = calculateLuminanceSRGB(r0.rgb);
