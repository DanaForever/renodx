// ---- Created with 3Dmigoto v1.3.16 on Mon Jul 07 02:52:53 2025
#include "../shared.h"
...
Texture2D<float4> SphereMapSampler : register(t7);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.z = r1.w ? 0 : r1.z;
  r1.x = r1.x * r1.y + r1.z;
  r1.y = dot(v5.xyz, Light0.m_direction.xyz);
  r1.y = r1.y * 0.5 + 0.5;
  ...
  r3.xyw = r1.zzz * r4.xyz + r3.xyw;
  r3.xyz = r3.zzz * r5.xyz + r3.xyw;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r7.xyz = NormalMap2Sampler.Sample(NormalMap2SamplerSampler_s, w3.xy).xyz;
  r7.xyz = r7.xyz * float3(2,2,2) + float3(-1,-1,-1);
  r1.z = r7.x * r1.w;
  r6.xyz = r7.yyy * r6.xyz;
  r4.xyz = r1.zzz * r4.xyz + r6.xyz;
  r4.xyz = r7.zzz * r5.xyz + r4.xyz;
  ...
  r0.w = 1 + -r1.x;
  r6.xyz = r4.xyz * scene.MiscParameters1.xyz + -r4.xyz;
  ...
  r1.xzw = RimLitColor.xyz * r1.xxx;
  r1.xzw = r1.xzw * r2.xyz + r4.xyz;
  r1.xzw = min(RimLightClampFactor, r1.xzw);
  r2.xyz = SphereMapIntensity * r5.xyz;
  r2.xyz = v1.xyz * r2.xyz;
  r0.xyz = r2.xyz * r1.yyy + r0.xyz;
  r1.xyz = v1.xyz * r1.xzw;
