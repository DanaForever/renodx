...
cbuffer _Globals : register(b0)
{
  ...
  float ShadowReceiveOffset : packoffset(c84.w) = {0.600000024};
  float BloomIntensity : packoffset(c85) = {0.699999988};
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.x = r2.w * 0.5 + 0.5;
  r3.y = 0;
  r2.w = CartoonMapSampler.SampleLevel(LinearClampSamplerState_s, r3.xy, 0).x;
  r3.xyz = Light0.m_colorIntensity.xyz * r2.www + scene.GlobalAmbientColor.xyz;
