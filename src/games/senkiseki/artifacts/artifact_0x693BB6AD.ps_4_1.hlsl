// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 03 18:36:50 2025
#include "../shared.h"
cbuffer _Globals : register(b0)
{
  ...
  float SphereMapIntensity : packoffset(c86.w) = {1};
  float BloomIntensity : packoffset(c87) = {1};
  float MaskEps : packoffset(c87.y);
...
Texture2D<float4> SphereMapSampler : register(t4);
