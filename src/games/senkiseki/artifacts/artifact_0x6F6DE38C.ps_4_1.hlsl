// ---- Created with 3Dmigoto v1.3.16 on Tue Aug 26 22:31:19 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float2 ProjectionScale : packoffset(c86) = {1,1};
  float BloomIntensity : packoffset(c86.z) = {1};
  float MaskEps : packoffset(c86.w);
...
SamplerState NormalMap2SamplerSampler_s : register(s6);
...
Texture2D<float4> NormalMap2Sampler : register(t5);
Texture2D<float4> ProjectionMapSampler : register(t6);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.x = r1.y * r1.z + r1.x;
  r1.yzw = NormalMapSampler.Sample(NormalMapSamplerSampler_s, v3.xy).xyz;
  ...
  r5.xy = cmp(v3.xy < float2(0,0));
  r5.xy = r5.xy ? float2(-1,-1) : float2(1,1);
  r1.y = r5.x * r1.y;
  r5.xzw = r4.xyz * r1.zzz;
  r5.xzw = r1.yyy * r2.xyz + r5.xzw;
  r1.yzw = r1.www * r3.xyz + r5.xzw;
  r2.w = dot(r1.yzw, r1.yzw);
  r2.w = rsqrt(r2.w);
  r1.yzw = r2.www * r1.yzw;
  r5.xzw = NormalMap2Sampler.Sample(NormalMap2SamplerSampler_s, w3.xy).xyz;
  r5.xzw = r5.xzw * float3(2,2,2) + float3(-1,-1,-1);
  r2.w = r5.x * r5.y;
  ...
  r2.w = saturate(dot(r1.yzw, r3.xyz));
  r3.x = dot(Light0.m_direction.xyz, r1.yzw);
  r3.x = r3.x * 0.5 + 0.5;
  r3.x = r3.x * r3.x;
  r3.yzw = SpecularColor.xyz * Light0.m_colorIntensity.xyz;
  r2.xyz = r2.xyz * r0.www + Light0.m_direction.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = rsqrt(r0.w);
  ...
  r0.w = min(1, r0.w);
  r0.w = Shininess * r0.w;
  r2.xyz = Light0.m_colorIntensity.xyz * r3.xxx + scene.GlobalAmbientColor.xyz;
  r2.xyz = min(float3(1.5,1.5,1.5), r2.xyz);
  r2.xyz = r3.yzw * r0.www + r2.xyz;
  r0.w = 1 + -r1.x;
  ...
  r2.xyz = scene.FogColor.xyz + -r0.xyz;
  ...
  r2.xyz = r1.xxx * scene.MonotoneMul.xyz + scene.MonotoneAdd.xyz;
  ...
  r1.x = calculateLuminanceSRGB(r2.rgb);
