// ---- Created with 3Dmigoto v1.3.16 on Sun Jul 27 15:12:04 2025
...
Texture2D<float4> ProjectionMapSampler : register(t4);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.w = r2.w + r0.w;
  r0.w = min(1, r0.w);
  r1.xy = ProjectionMapSampler.Sample(LinearWrapSamplerState_s, w3.xy).xw;
  r1.x = -r1.x * r1.y + 1;
  r0.w = min(r1.x, r0.w);
  r1.x = 1 + -r0.w;
  ...
  r1.w = calculateLuminanceSRGB(r0.xyz);
