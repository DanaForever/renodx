// ---- Created with 3Dmigoto v1.3.16 on Sat Jul 19 17:11:29 2025
#include "../shared.h"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = dot(Light0.m_direction.xyz, r1.xyz);
  r1.w = r1.w * 0.5 + 0.5;
  r1.w = r1.w * r1.w;
  r2.xyz = Light0.m_colorIntensity.xyz * r1.www + scene.GlobalAmbientColor.xyz;
