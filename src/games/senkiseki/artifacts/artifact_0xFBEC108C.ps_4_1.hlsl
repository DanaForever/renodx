// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 10 22:50:16 2025
#include "../shared.h"
cbuffer _Globals : register(b0)
{
  ...
  float CubeMapIntensity : packoffset(c87.z) = {1};
  float CubeMapFresnel : packoffset(c87.w) = {0};
  float BloomIntensity : packoffset(c88) = {1};
  float MaskEps : packoffset(c88.y);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.x = r4.x * 0.5 + 0.5;
  r4.x = r4.x * r4.x;
  r4.yzw = SpecularColor.xyz * Light0.m_colorIntensity.xyz;
  ...
  r0.w = 1 + -r0.w;
  // r0.w = log2(r0.w);
  // r1.x = RimLitPower * r0.w;
  // r1.x = exp2(r1.x);
  r1.x = renodx::math::SafePow(r0.w, RimLitPower);
  r1.x = RimLitIntensity * r1.x;
  r4.xyz = RimLitColor.xyz * r1.xxx;
  r3.xyz = r4.xyz * r1.yzw + r3.xyz;
