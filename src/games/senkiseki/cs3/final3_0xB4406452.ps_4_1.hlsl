// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 03 16:57:48 2025
...
float3 CompositeColor(float4 depthColor, float4 toneColor, float4 glareColor, float4 filterColor, bool Bloom) {
  float4 r0, r1, r2, r3;
  r0 = depthColor;
  r1 = toneColor;
  r2 = filterColor;
