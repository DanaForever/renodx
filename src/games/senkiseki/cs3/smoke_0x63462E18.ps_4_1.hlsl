// ---- Created with 3Dmigoto v1.3.16 on Sat Jul 19 17:03:38 2025
#include "../shared.h"
...
cbuffer _Globals : register(b0)
{
  ...
  float2 WindyGrassDirection : packoffset(c63.z) = {0,0};
  float WindyGrassSpeed : packoffset(c64) = {0.100000001};
  float WindyGrassHomogenity : packoffset(c64.y) = {2};
  float WindyGrassScale : packoffset(c64.z) = {1};
  float BloomIntensity : packoffset(c64.w) = {1};
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.w = r0.w;
  o0.xyz = GameMaterialMonotone * r0.xyz + r1.xyz;
  // o0.w = max(o0.w, 0.f);
  o0 = max(o0, 0.f);
  return;
}