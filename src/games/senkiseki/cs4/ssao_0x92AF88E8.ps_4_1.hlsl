// ---- Created with 3Dmigoto v1.3.16 on Fri Jun 06 22:23:38 2025
...
Texture2D<float4> FocusBuffer : register(t2);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = FocusBuffer.SampleLevel(PointClampSamplerState_s, r0.xy, 0).w;
  r0.z = 255.000015 * saturate(r0.z);
  r0.z = (uint)(r0.z + 0.5);
  r0.zw = (int2)r0.zz & int2(1,2);
  r1.x = GlareBuffer.SampleLevel(LinearClampSamplerState_s, r0.xy, 0).x;
  r2.xyzw = ColorBuffer.SampleLevel(LinearClampSamplerState_s, r0.xy, 0).xyzw;
  r0.x = r0.z ? 1 : r1.x;
  r0.x = r0.w ? 1 : r0.x;
  r0.yzw = SSAOParams.xyz * r2.xyz;
  r1.xyz = -r2.xyz * SSAOParams.xyz + r2.xyz;
  o0.w = r2.w;
