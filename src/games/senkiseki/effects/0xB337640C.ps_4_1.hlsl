// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 03 19:27:51 2025
#include "../shared.h"
// black flame
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xy = uiDest.xy;
  r1.xy = (uint2)r1.xy;
  r2.xyz = v4.xyz / v4.www;
  r1.zw = r2.xy * float2(0.5,0.5) + float2(0.5,0.5);
  r2.x = r2.z * scene.cameraFarMinusNear + -scene.cameraNearFar.y;
  r2.x = scene.cameraNearTimesFar / r2.x;
  r3.x = inputDownscaleFactor * r1.z;
  r3.z = -r1.w * inputDownscaleFactor + 1;
  r1.xy = r3.xz * r1.xy;
  r1.xy = (int2)r1.xy;
  r1.zw = float2(0,0);
  r1.x = DepthBuffer.Load(r1.xy, 0).x;
