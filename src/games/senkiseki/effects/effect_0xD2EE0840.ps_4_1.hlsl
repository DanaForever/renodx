...
cbuffer _Globals : register(b0)
{
  ...
  float4 OutlineColorFactor : packoffset(c88) = {1,1,1,1};
  float3 OutlineColor : packoffset(c89) = {0.699999988,0.5,0.300000012};
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (r0.w != 0) {
    r2.xyz = Light0.m_direction.xyz * ShadowReceiveOffset + v4.xyz;
  ...
  r2.w = dot(LightDirForChar.xyz, r3.xyz);
  r3.x = r2.w * 0.5 + 0.5;
  r3.y = 0;
