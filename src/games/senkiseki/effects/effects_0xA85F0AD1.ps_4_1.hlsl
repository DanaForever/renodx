// ---- Created with 3Dmigoto v1.3.16 on Sat Jun 21 00:40:42 2025
#include "../shared.h"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.z = r1.z * scene.cameraFarMinusNear + -scene.cameraNearFar.y;
  r1.z = scene.cameraNearTimesFar / r1.z;
  r2.x = inputDownscaleFactor * r1.x;
  r2.z = -r1.y * inputDownscaleFactor + 1;
  r1.x = DepthBuffer.Sample(PointClampSamplerState_s, r2.xz).x;
  r1.x = r1.x * scene.cameraFarMinusNear + -scene.cameraNearFar.y;
  r1.x = scene.cameraNearTimesFar / r1.x;
  r1.y = -r1.z + r1.x;
  r1.y = r1.y / inputSoftCheckDepthParam.x;
  r1.w = cmp(r1.x < r1.z);
  r1.x = -r1.x + r1.z;
  r1.x = r1.x / inputSoftCheckDepthParam.x;
  r1.yz = float2(1,1) + -r1.yx;
  r1.y = r1.w ? r1.z : r1.y;
  r1.y = inputSoftCheckDepthParam.y * r1.y;
  r1.z = 1 + -inputSoftCheckDepthParam.y;
