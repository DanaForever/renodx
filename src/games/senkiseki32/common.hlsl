...
float3 processAndToneMap(float3 color) {
  ...
  float3 sdr_color = renodx::tonemap::Reinhard(max(0.f, color));
  color = renodx::color::correct::Hue(color, sdr_color, RENODX_TONE_MAP_HUE_CORRECTION, RENODX_TONE_MAP_HUE_CORRECTION_METHOD);
