 // ---- Created with 3Dmigoto v1.3.16 on Sun Aug 24 17:56:57 2025
#include "common.hlsl"
...
cbuffer cb_local2 : register(b3)
{
  ...
  float4x4 prevViewProj_g : packoffset(c1);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r3.x != 0) {
    r1.xy = (uint2)r1.xy;
    r4.zw = r1.xy * float2(3.05180438e-005,3.05180438e-005) + float2(-1,-1);
