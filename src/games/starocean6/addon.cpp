...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x3E64215C),  // 10k ui
    CustomShaderEntry(0x91232E60),  // LUT Tonemap
    CustomShaderEntry(0x3E1BECFB),  // LUT Tonemap cutscene
    CustomShaderEntry(0x87DD5DB2),  // swapchain
    CustomShaderEntry(0x7F3616AD),  // ui
    CustomShaderEntry(0x24A6733B),  // ui 
    CustomShaderEntry(0x24CD51B7),  // ui
    CustomShaderEntry(0x5E6749C1),  // ui
    CustomShaderEntry(0xAE98E66A),  // ui
    CustomShaderEntry(0x2716E56D),  // ui
    CustomShaderEntry(0x2043BE2D),  // TAA
    CustomShaderEntry(0x9BD6AB9D),  // TAA
    CustomShaderEntry(0x7480279F),  // dof
    CustomShaderEntry(0xB6D9473A),  // dof
    CustomShaderEntry(0x470384EC),  // dof
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "TAADisabler",
        .binding = &shader_injection.taa,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .can_reset = true,
        .label = "Temporal Anti-Aliasing",
        .section = "Game Setting",
        .tooltip = "Enabling/Disabling TAA",
        .labels = {"Enabled", "Disabled"},
    },
    new renodx::utils::settings::Setting{
        .key = "DOFDisabler",
        .binding = &shader_injection.depthoffield,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .can_reset = true,
        .label = "Depth of Field",
        .section = "Game Setting",
        .tooltip = "Enabling/Disabling DOF",
        .labels = {"Enabled", "Disabled"},
    },
    new renodx::utils::settings::Setting{
        .key = "DitheringDisabler",
        .binding = &shader_injection.dithering,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .can_reset = true,
        .label = "Dithering",
        .section = "Game Setting",
        .tooltip = "Enabling/Disabling Dithering",
        .labels = {"Enabled", "Disabled"},
    },
    new renodx::utils::settings::Setting{
        .key = "VignetteDisabler",
        ...
        .label = "Vignette",
        .section = "Game Setting",
        .tooltip = "Enabling/Disabling Vignette",
        .labels = {"Enabled", "Disabled"},
    },
    new renodx::utils::settings::Setting{
        .key = "ToneMapType",
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Star Ocean 6";
