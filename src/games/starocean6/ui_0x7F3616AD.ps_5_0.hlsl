// ---- Created with 3Dmigoto v1.3.16 on Tue Jun 03 14:56:58 2025
#include "shared.h"
#include "so6utils.hlsl"
cbuffer _Globals : register(b0)
{
  row_major float2x4 eamUVShiftMatrix[8] : packoffset(c0);
  float4 eALBEDO_CONSTCOLOR0 : packoffset(c16);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = eALBEDO_CONSTCOLOR0.xyzw * r0.xyzw;
