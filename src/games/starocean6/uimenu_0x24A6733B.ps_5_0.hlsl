// ---- Created with 3Dmigoto v1.3.16 on Tue Jun 03 19:26:19 2025
#include "shared.h"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = asTexObject_0_.Sample(asTexSamp_0__s, v3.xy).x;
  r0.y = asTexObject_1_.Sample(asTexSamp_1__s, v3.xy).x;
  r0.z = asTexObject_2_.Sample(asTexSamp_2__s, v3.xy).x;
  r0.xyz = float3(-0.0627451017,-0.501960814,-0.501960814) + r0.xyz;
  r0.zw = float2(1.59599996,0.813000023) * r0.zz;
  r1.x = r0.x * 1.16400003 + r0.z;
  r0.z = 2.01699996 * r0.y;
  r0.y = r0.y * -0.39199999 + -r0.w;
  r1.y = r0.x * 1.16400003 + r0.y;
  r1.z = r0.x * 1.16400003 + r0.z;
  r1.w = asTexObject_3_.Sample(asTexSamp_3__s, v3.xy).x;
