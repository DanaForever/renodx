// ---- Created with 3Dmigoto v1.3.16 on Tue Jun 03 23:42:37 2025
#include "shared.h"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xw = asTexObject_0_.Sample(asTexSamp_0__s, v3.xy).xw;
  r1.x = asTexObject_1_.Sample(asTexSamp_1__s, v3.xy).x;
  r1.y = asTexObject_2_.Sample(asTexSamp_2__s, v3.xy).x;
  r1.z = -0.0627451017 + r0.x;
  r1.xy = float2(-0.501960814,-0.501960814) + r1.xy;
  r1.yw = float2(1.59599996,0.813000023) * r1.yy;
  r0.x = r1.z * 1.16400003 + r1.y;
  r1.y = 2.01699996 * r1.x;
  r1.x = r1.x * -0.39199999 + -r1.w;
  r0.y = r1.z * 1.16400003 + r1.x;
  r0.z = r1.z * 1.16400003 + r1.y;
