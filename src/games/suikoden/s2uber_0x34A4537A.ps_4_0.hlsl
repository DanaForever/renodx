  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = -r1.xywy * cb0[34].xxxx + v1.xyxy;
  ...
  r2.xyzw = r1.zywy * cb0[34].xxxx + v1.xyxy;
  // r1.xy = saturate(r1.xy * cb0[34].xx + v1.xy);
  r1.xy = r1.xy * cb0[34].xx + v1.xy;
  ...
  r0.xyzw = cb0[34].yyyy * r0.xyzw;  // bloom finish
  ...
  r3.xyz = renodx::color::srgb::DecodeSafe(r1.xyz);
  ...
  // post-bloom-tonescaling is better here. 
  // float3 untonemapped = r0.xyz;
  
  // untonemapped = renodx::color::from::bt

  // srgb gamma encoding start
  ...
  // srgb gamma encoding end

  // srgb based postprocessing
  ...
  // o0.rgb = renodx::draw::ToneMapPass(sdr);
  o0.rgb = sdr;
