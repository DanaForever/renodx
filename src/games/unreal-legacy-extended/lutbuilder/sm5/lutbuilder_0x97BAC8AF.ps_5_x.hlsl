...
// ---- Created with 3Dmigoto v1.3.16 on Wed Jan  1 15:35:38 2025
...
void main(
  ...
  float4 lutweights[2] = { float4(asfloat(cb0[38].x), asfloat(cb0[39].x), asfloat(cb0[40].x), 0.f), float4(0.f, 0.f, 0.f, 0.f) };
