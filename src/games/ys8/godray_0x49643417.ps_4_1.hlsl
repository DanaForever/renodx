// ---- Created with 3Dmigoto v1.3.16 on Fri Jul 18 02:57:01 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
  r1.x = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
  r1.y = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
  r1.z = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
  r1.w = max(r0.w, r0.y);
  r2.x = min(r0.w, r0.y);
  r1.w = max(r1.x, r1.w);
  r2.x = min(r2.x, r1.x);
  ...
  if (r2.x != 0) {
    ...
    r2.z = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
    r2.w = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
    r3.x = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
    r3.y = tex_tex.SampleLevel(LinearClampSamplerState_s, v0.xy, 0, int2(0, 0)).y;
    r3.z = r1.y + r0.w;
    r3.w = r1.z + r1.x;
    r1.w = 1 / r1.w;
    r4.x = r3.z + r3.w;
